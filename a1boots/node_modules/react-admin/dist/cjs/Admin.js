...
var Admin = function (props) {
    ...
    notification = props.notification, queryClient = props.queryClient, requireAuth = props.requireAuth, store = props.store, ready = props.ready, theme = props.theme, lightTheme = props.lightTheme, darkTheme = props.darkTheme, defaultTheme = props.defaultTheme, _a = props.title, title = _a === void 0 ? 'React Admin' : _a;
    ...
    return (React.createElement(ra_ui_materialui_1.AdminContext, { authProvider: authProvider, basename: basename, dataProvider: dataProvider, i18nProvider: i18nProvider, store: store, history: history, queryClient: queryClient, theme: theme, lightTheme: lightTheme, darkTheme: darkTheme, defaultTheme: defaultTheme },
        React.createElement(ra_ui_materialui_1.AdminUI, { layout: layout, dashboard: dashboard, disableTelemetry: disableTelemetry, menu: menu, catchAll: catchAll, title: title, loading: loading, loginPage: loginPage, authCallbackPage: authCallbackPage, notification: notification, requireAuth: requireAuth, ready: ready }, children)));
};
exports.Admin = Admin;
